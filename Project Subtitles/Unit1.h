...
__published:	// IDE-managed Components
        ...
        TMenuItem *Dzialanie1;
        TMenuItem *Przyspieszanie1;
        TMenuItem *Opoznianie1;
        TGroupBox *GroupBox1;
        TLabel *Label1;
        TLabel *Label2;
        TLabel *Label3;
        ...
        TEdit *Edit3;
        TButton *Button1;
        TMenuItem *Stronaprojektu1;
        TMenuItem *Jezyk1;
        TMenuItem *Polski1;
        TMenuItem *Angielski1;
        ...
        void __fastcall Przyspieszanie1Click(TObject *Sender);
        void __fastcall Opoznianie1Click(TObject *Sender);
        void __fastcall Button1Click(TObject *Sender);
        void __fastcall ChangeSub(bool l,String name1,String n, String s, String e,char type);
        void __fastcall DealWithType(char type);
        void __fastcall OpenFile(String type);
        void __fastcall Polski1Click(TObject *Sender);
        void __fastcall LangChange(char lang,char l);
        void __fastcall Angielski1Click(TObject *Sender);
